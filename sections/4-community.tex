...
NumFOCUS provides financial and organizational support for several important packages (e.g., \package{numpy}, \package{pandas} and \package{xarray}) and facilities collaboration between packages throughout the scientific Python ecosystem.
