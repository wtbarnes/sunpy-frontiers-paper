...
NumFOCUS provides financial and organizational support for several important packages (e.g., \package{numpy}, \package{pandas} and \package{xarray}) and facilitates collaboration between packages throughout the scientific Python ecosystem.
...
Examples of successful projects include the conversion to using \package{astropy.time} and creating a new Python API wrapper for Helioviewer.org\footnote{\url{https://hvpy.readthedocs.io/}}.
