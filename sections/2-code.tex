...
Whereas for \code{TimeSeries}, the metadata is commonly in a very different style, so there is generally little overlap between the metadata of a \code{TimeSeries} object and the metadata of a \code{Map} object.
